...
export const PERMISSION_CATALOG: PermModuleDef[] = [
  ...
  // ----- Training Management -----
  {
    ...
    category: 'training',
    actions: [
      A('view', 'View Courses', 'Browse training courses.'),
      A('create', 'Create Course', 'Create a new training course.'),
      A('edit', 'Edit Course', 'Edit a course. On a published course, edits are staged until the e-signed publish.'),
      A('revise', 'Revise (New Version)', 'Create a new version of a published course (triggers re-training).'),
      A('archive', 'Archive / Unpublish', 'Archive or unpublish a course.'),
      A('approve', 'Publish (e-signed)', 'Publish a course or its staged changes — requires an electronic signature.'),
      A('assign', 'Assign Course', 'Assign a course to users for training.'),
  ...
  },
  {
    ...
    category: 'training',
    actions: [
      A('view', 'View Questions', "View a course's assessment questions."),
      A('create', 'Create Question', 'Add a new question to a course.'),
